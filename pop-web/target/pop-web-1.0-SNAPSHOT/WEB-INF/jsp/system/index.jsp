            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list"><a href=""><i class="fa fa-laptop"></i>
                    ...
                    <ul class="sub-menu-list">
                        <li><a href="${base}system/adminList.htm"> 用户管理</a></li>
                ...
                <li><a href="login.html"><i class="fa fa-sign-in"></i> <span>退出登录</span></a></li>
                ...
                <ul class="notification-menu">
                    ...
                    <li>
                        <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                            <img src="${base}images/photos/user-avatar.png" alt=""/>
                            ${adminUser.nickName}
                            <span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                            <li><a href="#"><i class="fa fa-user"></i> 个人资料</a></li>
                            <li><a href="#"><i class="fa fa-cog"></i> 我的权限</a></li>
